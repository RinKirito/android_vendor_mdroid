...
ifeq ($(MDROID_BUILDTYPE), UNOFFICIAL)
    MDROID_VERSION := $(MDROID_REVISION)-$(MDROID_CODENAME)-$(MDROID_BUILDTYPE)-$(TARGET_PRODUCT_SHORT)-$(shell date +"%Y%m%d-%H%M%S")
else
    MDROID_VERSION := $(MDROID_REVISION)-$(MDROID_CODENAME)-$(MDROID_BUILDTYPE)-$(TARGET_PRODUCT_SHORT)-$(shell date +"%Y%m%d")
endif
